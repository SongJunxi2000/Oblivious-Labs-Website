...
but also the accesses to data." />
                    ...
                    <div className="col-md-3 mb-2">
                    <Card title="Applications of ORAM" img={card2} text="Our ORAM algorithm has is used by the Signal encrypted messenger for private contact discovery. ORAM can also be used in blockchains to enable private order flow and mitigate Miner Extractable Value (MEV). " />
                    </div>
<div className="col-md-3 mb-2">
