        ...
        <div className="card-cover">
            <div className="col-md-12">
                <div className="row">
                    ...
                    <div className="col-md-4 mb-2">
                    <Card title="Should I use ORAM?" img="card2.png" text="Consider using an ORAM if your application involves privately querying a large database, whether the database itself is secret or public. Read more." />
                    </div>
                    <div className="col-md-4 mb-2">
